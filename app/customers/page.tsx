      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between mb-6">
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-5 py-2 rounded-xl shadow-lg hover:scale-105 transition"
          >
            + Add Customer
          </button>
        </div>
...
{errorMsg && (
  <div className="text-red-600 text-sm bg-red-100 px-3 py-2 rounded-lg border border-red-200">
    {errorMsg}
  </div>
)}
        ...
        <div className="space-y-4">
          {filteredCustomers.map((c) => {
            ...
            return (
              <div
                key={c.id}
                className="p-[1.5px] rounded-2xl bg-gradient-to-r from-purple-500 via-indigo-500 to-pink-500"
              >
                <div className="bg-white/80 backdrop-blur-xl p-5 rounded-2xl shadow-lg">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2 items-center flex-wrap">
                      ...
                      <button
                        ...
                        className="px-3 py-1 rounded-full text-xs bg-blue-100 text-blue-600"
                      >
                        Edit
                      </button>
                      ...
                      <button
                        ...
                        className="px-3 py-1 rounded-full text-xs bg-indigo-100 text-indigo-600"
                      >
                        Renew
                      </button>
